...
namespace Aprimo.Opti.Core
{
    ...
    public class AprimoSearchProvider : ContentSearchProviderBase<AprimoAssetData, ContentType>
    {
        ...
        public AprimoSearchProvider(LocalizationService localizationService,
           ...
           : base(localizationService, siteDefinitionResolver, contentTypeRepository, editUrlResolver, serviceAccessor, contentLanguageAccessor, urlResolver, templateResolver, uiDescriptorRegistry)
        {
