...
namespace Aprimo.Opti.Core.Descriptors
{
    public static class EditorDescriptorExtender
    {
        ...
        public static void ModifyMetadata(ExtendedMetadata metadata, IEnumerable<Attribute> attributes)
        {
            ...
            metadata.EditorConfiguration["aprimoiconpath"] = "/episerver/Aprimo.Opti.Core/1.0.0/clientresources/scripts/editors/images/aprimo_opt_cropped.png";
            ...
            metadata.EditorConfiguration["aprimomodulepath"] = Paths.ToResource("Aprimo.Opti.Core", string.Empty);
        }
    }
}